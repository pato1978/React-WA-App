...
namespace WebAssembly.Server.Controllers
{
    ...
    public class ExpensesControllerStatic : ControllerBase
    {
        ...
        {   
            //newExpense.MonthKey = newExpense.Date.ToString("yyyy-MM");
            //newExpense.YearKey = newExpense.Date.ToString("yyyy");
